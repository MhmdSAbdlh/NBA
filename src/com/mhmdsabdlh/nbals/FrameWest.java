...
class FrameWest extends JFrame{

	static Team[] teams = FrameConf.West();
	...
	//Add items off the frame
		...
		Main.m11.addActionListener( e -> openWest(teamWin, teamLoss));
		Main.m12.addActionListener( e -> saveWest(teamWin, teamLoss));
	...
	private void saveWest(JSpinner[] teamWin, JSpinner[] teamLoss) {
		try {
	...
	private void openWest(JSpinner[] teamWin, JSpinner[] teamLoss) {
